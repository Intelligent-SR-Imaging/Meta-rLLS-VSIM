...
class DualGANASectionModel(BaseModel):
    ...
    def load_checkpoint(self, dataroot, map_location=None):
        if self.deconv_iter == 1:
            self.netF_A_list[0].load_state_dict(torch.load(dataroot + 'net_FA.pth'))
            self.netF_B_list[0].load_state_dict(torch.load(dataroot + 'net_FB.pth'))
            self.netG_list[0].load_state_dict(torch.load(dataroot + 'net_G.pth'))
            self.netD_A.load_state_dict(torch.load(dataroot + 'netD_A.pth'))
            self.netD_B.load_state_dict(torch.load(dataroot + 'netD_B.pth'))
        elif self.deconv_iter == 2:
            self.netF_A_list[0].load_state_dict(torch.load(dataroot + 'net_FA.pth'))
            self.netF_B_list[0].load_state_dict(torch.load(dataroot + 'net_FB.pth'))
            self.netG_list[0].load_state_dict(torch.load(dataroot + 'net_G.pth'))
            self.netF_B_list[1].load_state_dict(torch.load(dataroot + 'net_FB1.pth'))
            self.netF_A_list[1].load_state_dict(torch.load(dataroot + 'net_FA1.pth'))
            self.netG_list[1].load_state_dict(torch.load(dataroot + 'net_G1.pth'))
            self.RNL_Net_list[0].load_state_dict(torch.load(dataroot + 'net_RNL.pth'))
            self.netD_A.load_state_dict(torch.load(dataroot + 'netD_A.pth'))
            self.netD_B.load_state_dict(torch.load(dataroot + 'netD_B.pth'))
        else:
            self.netF_A_list[0].load_state_dict(torch.load(dataroot + 'net_FA.pth'))
            ...
            self.netG_list[1].load_state_dict(torch.load(dataroot + 'net_G1.pth'))
            self.RNL_Net_list[0].load_state_dict(torch.load(dataroot + 'net_RNL.pth'))
            self.netF_B_list[2].load_state_dict(torch.load(dataroot + 'net_FB1.pth'))
            self.netF_A_list[2].load_state_dict(torch.load(dataroot + 'net_FA1.pth'))
            self.netG_list[2].load_state_dict(torch.load(dataroot + 'net_G1.pth'))
            self.RNL_Net_list[1].load_state_dict(torch.load(dataroot + 'net_RNL.pth'))
            self.netD_A.load_state_dict(torch.load(dataroot + 'netD_A.pth'))
            self.netD_B.load_state_dict(torch.load(dataroot + 'netD_B.pth'))
