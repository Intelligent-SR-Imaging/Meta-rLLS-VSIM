...
def get_scheduler(optimizer, epoch_count ,lr_policy ,n_epochs ,n_epochs_decay ,lr_decay_iters):
...
def define_D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, use_sigmoid=True,
             gpu_ids=[], dimension =3):
...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, n_layers=3, norm_layer=None, use_sigmoid = True, dimension =3):
