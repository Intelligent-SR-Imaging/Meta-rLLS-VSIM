...
We have provided __Demo Data__ and __Pretrained Model__ at [Zenodo](https://zenodo.org/records/14322457). You can load __Demo Data__ and __Pretrained Model__ from our [Zenodo Dashboard](https://zenodo.org/records/14322457) and save them follow the notes.
```
